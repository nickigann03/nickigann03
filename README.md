...
My focus is on practical, hands-on experience in defensive security, including detection, response, and automation.

| Core Skill | Description | Associated Project |
| :--- | :--- | :--- |
| **SIEM & Log Analysis** | Implementation of SIEM systems (e.g., Splunk/Elastic) and advanced log analysis for threat hunting. | <a href="https://google.com">Detection Lab</a> |
| **Network Traffic Monitoring** | Monitoring network flows, analyzing protocol activity, and identifying malicious patterns using IDS/NSM. | <a href="https://google.com">Detection Lab</a> |
| **Security Automation (SOAR)** | Developing automation playbooks for alert triage and response using platforms like Shuffle. | SOC Automation Lab |
| **Incident Response** | Planning, documenting, and executing the phases of an incident response lifecycle (preparation to lessons learned). | SOC Automation Lab |
| **Case Management** | Utilizing platforms like TheHive for collaborative incident tracking and structured case management. | SOC Automation Lab |
...
Experience with industry-standard security tools for monitoring, analysis, and response.
...
### 🖥️ Endpoint Detection & Response (EDR) / Forensics
<p>
    <img src="https://img.shields.io/badge/-Microsoft_Defender_for_Endpoint-00A4EF?&style=for-the-badge&logo=Microsoft&logoColor=white" />
    <img src="https://img.shields.io/badge/-Velociraptor-4B275F?&style=for-the-badge&logo=Velociraptor&logoColor=white" />
</p>

### 🔁 Orchestration, Automation, & Response (SOAR) / Case Management
<p>
